										...
										<table id="vendor-list" class="table">
											...
											<tbody>
												...
												<tr>
													...
													<td><img class="cat-thumb" src="@/assets/admin/img/clients/7.jpg"
															alt="clients Image"><span class="name">Monsy pvt.</span>
													</td>
													<td>120</td>
													<td>50</td>
												...
												<tr>
													...
													<td><img class="cat-thumb" src="@/assets/admin/img/clients/8.jpg"
												...
												<tr>
													...
													<td><img class="cat-thumb" src="@/assets/admin/img/clients/9.jpg"
												...
												<tr>
													...
													<td><img class="cat-thumb" src="@/assets/admin/img/clients/10.jpg"
